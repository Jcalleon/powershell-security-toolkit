<#
.SYNOPSIS
    Get-ADObjectPermissionAudit — Audits ACLs on sensitive AD objects: AdminSDHolder, Domain Root, GPOs for unexpected delegations.
.DESCRIPTION
...
.EXAMPLE
    ./Get-ADObjectPermissionAudit.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: Get-ADObjectPermissionAudit" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "Get-ADObjectPermissionAudit_$Timestamp.csv"
