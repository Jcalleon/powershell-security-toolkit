<#
.SYNOPSIS
    New-IncidentReport — Generates a structured incident report HTML document from collected IR artifacts and timeline data.
.DESCRIPTION
...
.EXAMPLE
    ./New-IncidentReport.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: New-IncidentReport" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "New-IncidentReport_$Timestamp.csv"
