<#
.SYNOPSIS
    Get-MemoryIndicators — Searches process memory strings for known malware signatures and C2 patterns without requiring Volatility.
.DESCRIPTION
...
.EXAMPLE
    ./Get-MemoryIndicators.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: Get-MemoryIndicators" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "Get-MemoryIndicators_$Timestamp.csv"
