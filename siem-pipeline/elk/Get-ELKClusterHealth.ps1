<#
.SYNOPSIS
    Get-ELKClusterHealth — Monitors Elasticsearch cluster health, shard status, and index sizes for SIEM ops.
.DESCRIPTION
...
.EXAMPLE
    ./Get-ELKClusterHealth.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: Get-ELKClusterHealth" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "Get-ELKClusterHealth_$Timestamp.csv"
