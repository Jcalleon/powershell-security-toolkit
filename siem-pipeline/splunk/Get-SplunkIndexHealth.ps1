<#
.SYNOPSIS
    Get-SplunkIndexHealth — Checks Splunk index ingestion rates, license usage, and data source gaps for SIEM health monitoring.
.DESCRIPTION
...
.EXAMPLE
    ./Get-SplunkIndexHealth.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: Get-SplunkIndexHealth" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "Get-SplunkIndexHealth_$Timestamp.csv"
