<#
.SYNOPSIS
    Invoke-EndpointComplianceCheck — Comprehensive single-script endpoint compliance check: patch, EDR, Defender, BitLocker, firewall, local admins.
.DESCRIPTION
...
.EXAMPLE
    ./Invoke-EndpointComplianceCheck.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: Invoke-EndpointComplianceCheck" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "Invoke-EndpointComplianceCheck_$Timestamp.csv"
