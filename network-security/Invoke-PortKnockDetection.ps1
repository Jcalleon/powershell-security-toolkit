<#
.SYNOPSIS
    Invoke-PortKnockDetection — Detects port scanning and reconnaissance patterns in Windows firewall logs.
.DESCRIPTION
...
.EXAMPLE
    ./Invoke-PortKnockDetection.ps1 -OutputPath "C:\Reports"
.NOTES
...
Write-Host "[*] Starting: Invoke-PortKnockDetection" -ForegroundColor Cyan
...
$CsvPath = Join-Path $OutputPath "Invoke-PortKnockDetection_$Timestamp.csv"
